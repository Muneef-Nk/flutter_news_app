                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          searchbarController.text = provider.categories[index];
                          Provider.of<SearchScreenController>(context,
                                  listen: false)
                              .fetchNews(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            provider.dataModel?.articles?[index]
                                                    .urlToImage ??
                                                "",
                                            fit: BoxFit.cover,
                                          ),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                  onTap: () {
                                                    Provider.of<SavedNewsController>(context, listen: false)
                                                        .checkNewsSavedOrNot(SavedNewsModel(
                                                            category:
                                                                searchbarController
                                                                    .text,
